...
export const queryZoneByName = (zoneRecords: ZoneRecord[], name: string): ZoneRecord[] => {
  return zoneRecords.filter((rec: ZoneRecord) => {
    return fuzzyEquals(rec.name, name)
  })
}

export const queryZoneByPartialName = (zoneRecords: ZoneRecord[], name: string): ZoneRecord[] => {
  return zoneRecords.filter((rec: ZoneRecord) => {
    return fuzzyIncludes(rec.name, name)
  })
}
